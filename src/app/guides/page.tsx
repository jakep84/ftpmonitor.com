...
export const DOCS: Doc[] = [
  ...
  // -----------------------------
  {
    ...
    body: {
      ...
      fixes: [
        {
          title: "Fix checklist",
          steps: [
            "Verify the hostname spelling (copy/paste; watch for trailing spaces).",
            ...
            "Try an alternate resolver (e.g., 1.1.1.1 / 8.8.8.8) if allowed.",
          ],
        },
      ],
      commands: [
      ...
      faqs: [
        {
          q: "Is this an FTP/SFTP credential problem?",
          a: "No. DNS fails before any connection or authentication happens.",
        },
      ],
    },
    relatedSlugs: ["tcp-connection-failed", "tcp-connection-timeout-firewall"],
  },

  {
    ...
    body: {
      intro: [
        ...
        "This is usually a firewall/security-group block, routing issue, or the service is only reachable from inside a private network/VPN.",
      ],
      causes: [
        {
          title: "Common causes",
          bullets: [
            ...
            "Port is correct but upstream device silently drops packets",
          ],
        },
      ],
      fixes: [
        {
          title: "Fix checklist",
          steps: [
            "Confirm you’re using the correct port (FTP 21, SFTP 22, unless vendor says otherwise).",
      ...
      commands: [
        {
          ...
          lines: [
            "nc -vz <host> <port>",
            "telnet <host> <port>",
            "curl -v telnet://<host>:<port>  # sometimes helpful for raw TCP reachability",
          ],
        },
      ],
      faqs: [
        {
          q: "How is a timeout different from ECONNREFUSED?",
      ...
      fixes: [
        {
          ...
          steps: [
            ...
            "Try from another network or from inside the VPN if applicable.",
          ],
        },
      ],
      commands: [
        {
          ...
          lines: [
            "nc -vz <host> <port>",
            "telnet <host> <port>",
            "ssh -vvv <user>@<host> -p <port>  # for SFTP/SSH ports only",
          ],
        },
      ],
    },
...

  {
    ...
    body: {
      intro: [
        ...
        "This can be wrong credentials, wrong protocol (FTP vs FTPS vs SFTP), key issues, or account restrictions like IP allowlists.",
      ],
      causes: [
        {
          title: "Common causes",
          bullets: [
            ...
            "SFTP key auth required (password disabled) or wrong key/passphrase",
      ...
      fixes: [
        {
          title: "Fix checklist",
          steps: [
            "Copy/paste credentials carefully and re-try (watch trailing spaces).",
            "Confirm which protocol is required: FTP vs FTPS vs SFTP.",
            "If SFTP key auth is required, confirm the correct private key + passphrase and that the public key is installed server-side.",
            "Ask the server owner if there’s an IP allowlist restriction.",
            "Try a known-good client from the same network to compare behavior.",
          ],
        },
      ],
      faqs: [
        {
          q: "My credentials work in FileZilla but fail here — why?",
          a: "Often the client is using a different protocol (FTPS vs FTP) or a different port, or it’s running from a network that’s allowlisted.",
        },
      ],
    },
      ...
      causes: [
        {
          ...
          bullets: [
            ...
            "Server expects a different starting directory",
          ],
        },
      ],
      fixes: [
      ...
      causes: [
        {
          ...
          bullets: [
            ...
            "Works on LAN but fails from outside the network",
          ],
        },
      ],
      fixes: [
...

  {
    ...
    relatedSlugs: ["tcp-connection-failed", "sftp-connection-refused"],
  },
];
